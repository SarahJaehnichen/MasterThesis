...
Lastly, **the relationship between affective experiences and approach-avoidance behavior in men and in women** was explored by visualization of regression plots ([a03_00_sam_aat_congruent_regression_plots.m](a03_00_sam_aat_congruent_regression_plots.m) for congruent trials and [a03_01_sam_aat_regression_plots.m](a03_01_sam_aat_regression_plots.m) for responses regardless of condition) and conducting further linear mixed models ([a03_02_sam_aat_congruent_lmms.m](a03_02_sam_aat_congruent_lmms.m) and [a03_03_sam_aat_lmms.m](a03_03_sam_aat_lmms.m)).
